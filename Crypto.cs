...
namespace NeteaseMusicApi
{
    class Crypto
    {
        ...
        private string AesEncrypt(string plaintextData, string key, string iv = "0102030405060708")
        {
        ...
        private string RsaEncrypt(string text, string pubKey = pubKey, string modulus = modulus)
        {
        ...
        public Dictionary<string, string> Encrypt(object obj)
        {
